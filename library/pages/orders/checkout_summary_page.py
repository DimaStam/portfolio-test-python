...
class CheckoutSummaryPage:
    ...
    def __init__(self, page: Page):
        ...
        self.card_submit_button_store_1 = self.payu_card_frame_locator.get_by_role("button", name="Użyj")
    ...
    def add_order_comment(self):
        ...
        self.order_comment_input.fill("Testowe zamówienie")

    @allure.step("Select agreement checkbox")
    def select_agreement_checkbox(self, store_agreement):
        self.page.locator(store_agreement).check()
    ...
    def fill_card_fields(self, submit_button_locator):
        self.card_number.wait_for(state='visible')
        self.card_expiry_date.wait_for(state='visible')
        self.card_cvv_code.wait_for(state='visible')

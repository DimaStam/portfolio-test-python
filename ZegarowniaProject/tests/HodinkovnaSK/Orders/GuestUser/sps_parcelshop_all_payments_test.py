...
def checkout_summary_page(home_page, page: Page):
    ...
    time.sleep(2)
    checkout_shipping_page.select_delivery_method(DeliveryMethods.sps_parcelshop)
    checkout_shipping_page.select_sps_parcelshop_delivery_point()
...
def test_buy_product_with_payment_method(checkout_summary_page: CheckoutSummaryPage, payment_method_name, page: Page):
    ...
    # pytest -v --env=prod tests\HodinkovnaSK\Orders\GuestUser\sps_parcelshop_all_payments_test.py --headed --alluredir=C:\Users\Dima\Desktop\Testing\Python_Playwright\ZegarowniaProject\allure_results

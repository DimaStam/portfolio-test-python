...
from library.testdata.Orders.PaymentMethods import PaymentMethods
...
def test_buy_product_by_blik(home_page, page: Page):
    ...
    # pytest -v --env=stage tests\Zegarownia\Orders\GuestUser\CourierDHL\test_buy_product_by_Blik.py --headed
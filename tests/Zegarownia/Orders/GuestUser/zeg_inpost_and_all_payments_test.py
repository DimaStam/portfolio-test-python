...
def checkout_summary_page(home_page, page: Page):
    ...
    checkout_shipping_page.select_delivery_method(DeliveryMethods.inpost)
    checkout_shipping_page.select_inpost_delivery_point()
...
def test_buy_product_with_payment_method(checkout_summary_page: CheckoutSummaryPage, payment_method_name, page: Page):
    ...
    # pytest -v --env=prod tests\Zegarownia\Orders\GuestUser\InPost\test_buy_product_by_inpost_and_all_payments.py --headed --alluredir=C:\Users\Dima\Desktop\Testing\Python_Playwright\ZegarowniaProject\allure_results

...
def checkout_summary_page(page: Page, env):
    ...
    checkout_shipping_page.select_delivery_method(DeliveryMethods.ceska_posta)
...
def test_buy_product_with_payment_method(checkout_summary_page: CheckoutSummaryPage, payment_method_name, page: Page):
    ...
    # pytest -v --env=prod tests\HodinkovnaCZ\Orders\GuestUser\courier_and_all_payments_test.py --headed --alluredir=/Users/global/Desktop/Zegarownia/allure_results

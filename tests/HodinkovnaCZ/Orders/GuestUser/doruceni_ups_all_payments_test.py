...
def checkout_summary_page(home_page, page: Page):
    ...
    checkout_shipping_page.select_delivery_method(DeliveryMethods.doruceni_ups)
...
def test_buy_product_with_payment_method(checkout_summary_page: CheckoutSummaryPage, payment_method_name, page: Page):
    ...
    # pytest -v --env=prod tests\HodinkovnaCZ\Orders\GuestUser\doruceni_ups_all_payments_test.py --headed --alluredir=/Users/global/Desktop/Zegarownia/allure-results

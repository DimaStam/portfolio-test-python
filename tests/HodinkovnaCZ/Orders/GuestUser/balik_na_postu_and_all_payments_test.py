...
def checkout_summary_page(page: Page, env):
    ...
    checkout_shipping_page.select_delivery_method(DeliveryMethods.balik_na_postu)
    checkout_shipping_page.select_balik_na_postu_delivery_point()
...
def test_buy_product_with_payment_method(checkout_summary_page: CheckoutSummaryPage, payment_method_name, page: Page):
    ...
    if payment_method_name == HodinkovnaCZPaymentMethods.CARD:
        submit_button_locator = checkout_summary_page.card_submit_button_hodinkovna_cz
    ...
    # pytest -v --env=prod tests/HodinkovnaCZ/Orders/GuestUser/balik_na_postu_and_all_payments_test.py --headed --alluredir=/Users/global/Desktop/Zegarownia/allure_results

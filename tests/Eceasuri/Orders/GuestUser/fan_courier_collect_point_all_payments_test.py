...
def test_buy_product_with_payment_method(checkout_summary_page: CheckoutSummaryPage, payment_method_name, page: Page):
    ...
    # pytest -v --env=prod tests/Eceasuri/Orders/GuestUser/fan_courier_collect_point_all_payments_test.py --headed --alluredir=/Users/global/Desktop/Zegarownia/allure_results

...
def checkout_summary_page(page: Page, env):
    ...
    open_page(page, env['URL_ECE_PRODUCT'])
    ...
    checkout_shipping_page.select_delivery_method(DeliveryMethods.fan_courier_collect_point)
    checkout_shipping_page.select_fan_courier_collect_point()
...
def test_buy_product_with_payment_method(checkout_summary_page: CheckoutSummaryPage, payment_method_name, page: Page):
    ...
    if payment_method_name == EceasuriPaymentMethods.CARD:
        submit_button_locator = checkout_summary_page.card_submit_button_eceasuri
    ...
    # pytest -v --env=prod tests/Eceasuri/Orders/GuestUser/fan_courier_collect_point_all_payments_test.py --headed --alluredir=/Users/global/Desktop/Zegarownia/allure-results

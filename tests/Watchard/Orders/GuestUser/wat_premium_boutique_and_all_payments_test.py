...
def checkout_summary_page(page: Page, env):
    ...
    checkout_shipping_page.select_delivery_method(DeliveryMethods.free_shipping_zeg_saloon)
...
def test_buy_product_with_payment_method(checkout_summary_page: CheckoutSummaryPage, payment_method_name, page: Page):
    ...
    if payment_method_name == WatchardPaymentMethods.CARD:
        submit_button_locator = checkout_summary_page.card_submit_button_watchard
    ...
    # pytest -v --env=prod tests\Watchard\Orders\GuestUser\wat_premium_boutique_and_all_payments_test.py --headed --alluredir=/Users/global/Desktop/Zegarownia/allure-results

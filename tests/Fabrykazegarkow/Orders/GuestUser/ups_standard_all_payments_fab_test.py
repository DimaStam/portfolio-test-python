...
def test_buy_product_with_payment_method(checkout_summary_page: CheckoutSummaryPage, payment_method_name, page: Page):
    ...
    # pytest -v --env=prod tests\Fabrykazegarkow\Orders\GuestUser\ups_standard_and_all_payments_test.py --headed --alluredir=/Users/global/Desktop/Zegarownia/allure_results

...
def checkout_summary_page(home_page, page: Page):
    ...
    checkout_shipping_page.select_delivery_method(DeliveryMethods.ups_standard)
...
def test_buy_product_with_payment_method(checkout_summary_page: CheckoutSummaryPage, payment_method_name, page: Page):
    ...
    # pytest -v --env=prod tests\Fabrykazegarkow\Orders\GuestUser\ups_standard_and_all_payments_test.py --headed --alluredir=C:\Users\Dima\Desktop\Testing\Python_Playwright\ZegarowniaProject\allure_results

...
from library.services.close_cookies import CloseCookies
...
def pytest_addoption(parser):
    ...
    parser.addoption("--headed", action="store_true", default=False, help="Run browser with UI (disable headless)")
